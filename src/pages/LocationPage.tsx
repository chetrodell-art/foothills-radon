      ...
      <section className="py-12">
        <div className="container-pro">
          <div className="rounded-xl bg-primary p-8 text-center text-primary-foreground">
            ...
            <p className="mx-auto mt-3 max-w-xl text-primary-foreground/80">Locally owned, NRPP certified, and based nearby in Pine. Call us or request a free estimate — we respond within {company.responseHours}.</p>
