...
const BlogPostPage = () => {
  ...
  const schema = [
    breadcrumbSchema([
      { name: "Home", path: "/" },
      { name: "Blog", path: "/blog/radon-levels-colorado-foothills" },
  ...
  return (
    <Layout>
      <SEO
        ...
        schema={schema}
      />
      <Breadcrumbs items={[{ name: "Home", path: "/" }, { name: "Blog", path: "/blog/radon-levels-colorado-foothills" }, { name: post.title }]} />
          ...
          <div className="lg:col-span-2">
            ...
            {post.heroImage && (
              <div className="mt-6 overflow-hidden rounded-xl shadow-lg">
                <img src={post.heroImage} alt={post.title} className="h-full w-full object-cover" loading="lazy" />
              </div>
            )}
            ...
            <div className="mt-8 rounded-xl bg-primary p-6 text-primary-foreground">
              ...
              <p className="mt-2 text-primary-foreground/80">All Phase Radon is locally owned, NRPP certified, and based in Pine, CO. Call us or request a free estimate — we respond within {company.responseHours}.</p>
